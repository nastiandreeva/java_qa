...
public interface GeoIPServiceHttpPost {
    ...
    /**
     * <br/>Get Country Name by Country
     *                 ISO2 code<br/>Paramater:Country Code &nbsp;&nbsp;<b>Type:String<b/><br/>Country
     *                 code format is ALPHA-2 (CA - for Canada)
     *             
     */
    ...
    /**
     * <br/>Get Country and State XML
     *                 String for a given ip address in x.x.x.x format<br/><br/>Parameter:GetIpAddress address
     *                 &nbsp;&nbsp;&nbsp;&nbsp;<b>Type:String</b><br/><br/>Return:format
...
;
    ...
    /**
     * <br/>Get Country ISO2 code by
     *                 Country Name<br/>Paramater:Country Name &nbsp;&nbsp;<b>Type:String<b/>
     *             
     */
