...
public class ContactModificationTests extends TestBase{
  ...
  public void testContactModification() throws Exception {
    ...
    if (! app.getContactHelper().isThereAGroup()) { //предусловия на то, если нет контакта что бы выделить для удаления, то создать
    ...
    app.getContactHelper().fillNewContactForm(new ContactData("Анастасия", "Николаева", "Олеговна", "Ortho", "ООО \"SH\"",
